...
SHEAR_DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'evidence_condition_state_shear')
 
RELIAB_DATAFILE_PARH = os.path.join(os.path.abspath('./'), 'data', 'reliability')
...
#rmRv = Lognormal('r_flex', mean=rm_mean, stdv=rm_stdv)
#rmDistr = rmRv.rv
#rvRv = Lognormal('r_shear', mean=rv_mean, stdv=rv_stdv)
#rvDistr = rvRv.rv
#r_array = np.array([rmDistr, rvDistr])

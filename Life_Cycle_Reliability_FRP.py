...
#FLEXTURE_DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'no_evidence_flexure')
#SHEAR_DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'no_evidence_shear')
#RELIAB_DATAFILE_PARH = os.path.join(os.path.abspath('./'), 'data', 'reliability', 'frp', 'no_evidence_flexure')

FLEXTURE_DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'evidence_condition_state_flexure')
...
flexure_mean_history = np.loadtxt(flexure_datafile)[19,service_time>=EM_SHEAR_YR]
flexure_std_history = np.loadtxt(flexure_datafile)[20,service_time>=EM_SHEAR_YR]
flexure_cov_history = flexure_std_history/flexure_mean_history
# shear strength rc
shear_mean_history = np.loadtxt(shear_datafile)[21,service_time>=EM_SHEAR_YR]
shear_std_history = np.loadtxt(shear_datafile)[22,service_time>=EM_SHEAR_YR]

...
ME_SHEAR_RC_NOM = 1.0;           ME_SHEAR_RC_MEAN = 1.075;         ME_SHEAR_RC_COV = 0.120;      ME_SHEAR_RC_DISTR = 'lognormal';
# load variables
...
TFRP_NOM = 0.440;              TFRP_MEAN = 0.440;         TFRP_COV = 0.;          TFRP_DISTR = 'deterministic';
BFRP_NOM = 400;                BFRP_MEAN = 400;           BFRP_COV = 0.;          BFRP_DISTR = 'deterministic';
...
#model errors
ME_FLEX_FRPIC_NOM = 1.0;         ME_FLEX_FRPIC_MEAN = 1.13;        ME_FLEX_FRPIC_COV = 0.145;    ME_FLEX_FRPIC_DISTR = 'lognormal';
ME_FLEX_FRPRT_NOM = 1.0;         ME_FLEX_FRPRT_MEAN = 1.00;        ME_FLEX_FRPRT_COV = 0.170;    ME_FLEX_FRPRT_DISTR = 'lognormal';
ME_SHEAR_FRPS_NOM = 1.0;         ME_SHEAR_FRPS_MEAN = 1.54;        ME_SHEAR_FRPS_COV = 0.258;    ME_SHEAR_FRPS_DISTR = 'lognormal';
ME_SHEAR_FRPU_NOM = 1.0;         ME_SHEAR_FRPU_MEAN = 1.59;        ME_SHEAR_FRPU_COV = 0.226;    ME_SHEAR_FRPU_DISTR = 'lognormal';
ME_SHEAR_FRPW_NOM = 1.0;         ME_SHEAR_FRPW_MEAN = 1.44;        ME_SHEAR_FRPW_COV = 0.223;    ME_SHEAR_FRPW_DISTR = 'lognormal';

...
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_anchor', 'no_evidence_flexure')
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_anchor', 'evidence_condition_state_flexure')
...
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_bond', 'no_evidence_flexure')
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_bond', 'evidence_condition_state_flexure')
...
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_anchor_degrade', 'no_evidence_flexure')
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_anchor_degrade', 'evidence_condition_state_flexure')
...
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_bond_degrade', 'no_evidence_flexure')
#DATAFILE_PATH = os.path.join(os.path.abspath('./'), 'data', 'frp_U_bond_degrade', 'evidence_condition_state_flexure')
